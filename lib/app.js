...
//       `https://api.giphy.com/v1/gifs/random?key=${process.env.GIPHY_KEY}&tag=animal&rating=g
//     `);
//     const { data } = await apiResp.json();
//     const returnPic = data.image_url;
//     const sqlResponse = await client.query(`UPDATE users 
//     SET profile_pic = $2,
//     email =$3,
//     hash = $4
//     RETURNING *`, 
//     [req.userId, returnPic, users.email]);
